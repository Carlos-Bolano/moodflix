        ...
        <article className="w-full flex flex-col items-center max-w-[900px] p-2 lg:px-5 pb-10">
          <div className="flex flex-col lg:flex-row justify-center items-center gap-6">
            ...
            <div className="text-center lg:text-start">
              ...
              <div className="flex gap-5 mt-3 justify-center lg:justify-start ">
                <Link
                  className="hover:-translate-y-1 hover:fill-red-400 transition-all duration-200 fill-slate-700"
                  title="Email"
